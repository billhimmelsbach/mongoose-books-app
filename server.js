...
app.get('/api/books/:id', function (req, res) {
  ...
  db.Book.findById(bookId, function(err, book) {
...
// app.put('/api/books/:id:title:author', function (req, res) {
...
//   db.Book.new(newBook, function(err, book) {
//     var post = newBook;
//   });
//     if (err) { return console.log("index error: " + err); }
//     res.json(book);
...
app.delete('/api/books/:id', function (req, res) {
    // find one book by its id
    var bookId = req.params.id;
    db.Book.findOneAndRemove({_id: bookId}, function(err, book) {
      if (err) { return console.log("index error: " + err); }
      res.json(book);
    });
  });
